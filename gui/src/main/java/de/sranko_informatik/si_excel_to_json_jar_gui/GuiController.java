...
import de.sranko_informatik.si_excel_to_json_jar_core.ExcelParserException;
...
public class GuiController {
    ...
    public ResponseEntity<TainasResponse> uploadFile(@RequestParam(name = "file") MultipartFile file,
        ...
        } catch ( ExcelParserException | IllegalStateException | NullPointerException | IOException e) {
            StringWriter sw = new StringWriter();
            PrintWriter pw = new PrintWriter(sw);
            e.printStackTrace(pw);
